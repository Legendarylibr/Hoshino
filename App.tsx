                    ...
                    <MoonlingCollection
                        characters={[
                            ...
                            },
                            {
                                ...
                                nftMint: ownedCharacters.includes('io') ? 'mint_address_io' : null
                            },
                            {
                                id: 'sirius_collection',
                                name: 'Sirius',
                            ...
                            },
                            {
                                id: 'aurora',
                                name: 'Aurora',
                                description: 'Radiant spirit of cosmic light',
                                image: '/hoshino-character.png',
                                element: 'Light',
                                baseStats: { mood: 4, hunger: 2, energy: 5 },
                                rarity: 'Epic',
                                specialAbility: 'Aurora Shield - Reduced stat decay when active',
                                nftMint: ownedCharacters.includes('aurora') ? 'mint_address_aurora' : null
                            }
                        ]}
